...
if(isset($_POST['submit']))
  {
    ...
    $dat=Date('Y/m/d');
    $sql="INSERT INTO `notification` (`notification`, `date`) VALUES ('$notify', '$dat')";
  ...
  <section id="content">
    <div class="container_12">
      <!-- <div class="grid_8"> -->
        ...
        <center>
        <form  method="post">
          <h2 class="top-1 p3" style="color: white">Notifications</h2>
          <table align="center">
            <tr>
                            <td> </td>
                            <td><textarea id="w3review" name="notify" rows="4" cols="50">
