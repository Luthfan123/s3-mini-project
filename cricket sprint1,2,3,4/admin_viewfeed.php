<?php
  ...
  // include('dbconnection.php');
  $sql="select a.*,b.name from FEEDBACK as a, member as b where  a.mem_id=b.mem_id order by mem_id desc";
  // echo "$sql";
    ...
    <div class="container_12">
      <div class="grid_8">
        ...
        <tr>
          ...
          <td><a href="admin_reply.php?id=<?php echo $idd; ?>">Reply</a></td>
