...
if(isset($_GET['id']))
  {
    $idd=$_GET['id'];
    $sql="select * from feedback where fid=$idd";
    $cres=$con->query($sql);
    ...
    if ($_SESSION['act']=="Edit")
        {
          ...
          $sql="UPDATE `feedback` SET `reply` = '$rep' WHERE `feedback`.`fid` = '$id'";
          $result=$con->query($sql);
        }
       
 
        
        header("Location:admin_viewfeed.php");
  }
  ...
  <section id="content">
    <div class="container_12">
      <!-- <div class="grid_8"> -->
        ...
        <center>
        <form  method="post">
          <h2 class="top-1 p3" style="color: white">Reply</h2>
          <table align="center">
            <tr>
                            <td>Feedback&nbsp;</td>
                            <td><input type="text" readonly style="width:200px" name="feed" value="<?php echo $feed; ?>"></td>
                          </tr>
                          <tr>
                            <td>Reply</td>
                            <td><textarea name="reply" required></textarea></td>
                          </tr>
