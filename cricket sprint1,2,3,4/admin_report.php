<?php
  ...
  // $sql="select a.*,b.name from batch as a,member as b where a.mem_id=b.mem_id";
  $sql="select count(*) as cnt, type from batch group by type";
  // echo "$sql";
...
<div class="main">
  ...
  <section id="content">
    <div class="container_12">
     ...
     <h2 class="top-1 p3" style="color: white">Batch Count</h2>
        <table align="center">
          <tr>
            <!-- <th>Bid</th> -->
          <th>Batch</th>
