      ...
      <table align="center">
          ...
          <td>
            <?php 
              ...
              { 
            ?>
                <a href="user_confirmbook.php?id=<?php echo $slot[$i]; ?>"><button style="margin-right:10px;background-color: green;margin-top:15px;"><?php echo $slot[$i] ?></button></a>
            <?php
             }
             else
             {
            ?>
                <button style="margin-right:10px;background-color: red;margin-top:15px;"><?php echo $slot[$i] ?></button>
            <?php
             }
            ?>
