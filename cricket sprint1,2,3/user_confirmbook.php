  ...
  <section id="content">
    <div class="container_12">
      <!-- <div class="grid_8"> -->
        ...
        <center>
        <form  method="post">
          <h2 class="top-1 p3" style="color: white"></h2>
          <table align="center">
            <tr>
            <td>Slot</td>
            <td><input type="text" name="slot" value="<?php echo $idd ?>" readonly></td>
          </tr>
          <tr>
            <td>Date</td>
            <td><input type="text" name="date" value="<?php echo $bdate ?>" readonly></td>
          </tr>
          <tr>
            <td></td>
